...
var MainNetParams = Params{
	...
	PowLimitBits:  0xffffffff, // @DONE-UFO
	...
	TargetTimespan:           time.Second * 10, // 10 seconds
	TargetTimePerBlock:       time.Minute,      // 10 minutes //DONE-UFO
	...
	PubKeyHashAddrID:        0x23, // starts with F @DONE-UFO
...
var SimNetParams = Params{
	...
	TargetTimespan:           time.Hour * 24 * 14, // 14 days
	// TargetTimePerBlock:       time.Minute * 10,    // 10 minutes
	TargetTimePerBlock:       time.Minute, // 1 minutes //@DONE-UFO
	RetargetAdjustmentFactor: 4,           // 25% less, 400% more
	ReduceMinDifficulty:      true,
	MinDiffReductionTime:     time.Minute * 20, // TargetTimePerBlock * 2
	GenerateSupported:        true,
