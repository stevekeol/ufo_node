...
// var defaultMiningAddrs = []string{"F6UEC6MSyYRPiEwHB7q2ceJeat7TSPDvbc"} //@DONE-UFO
...
const (
	...
	// defaultMaxPeers              = 125
	defaultMaxPeers = 0 // @DONE-UFO
	// defaultDisableListen         = true //@DONE-UFO (New Add)
...
func loadConfig() (*config, []string, error) {
	...
	cfg := config{
		...
		// DisableListen: defaultDisableListen, //@DONE-UFO (New Add)
		MaxPeers: defaultMaxPeers,
		// MiningAddrs:          defaultMiningAddrs, //@DONE-UFO （New Add）
